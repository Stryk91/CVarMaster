...
-- Updated: 2026-01-02 - Added SoftTarget, CameraFollow, Delves, Ping, AdvFlying CVars
CVarMaster.KnownCVars = {
    ...
    "xpBarText",
    -- ============================================
    -- SOFT TARGET / ACTION TARGETING SYSTEM (10.0+)
    -- ============================================
    "SoftTargetEnemy",
    "SoftTargetEnemyArc",
    ...
    "cameraLockedTargetFocusing",
    -- ============================================
    -- ADVANCED FLYING / DRAGONRIDING (10.0+)
    -- ============================================
    ...
    -- ============================================
    -- PREEMPTIVE CAST / SPELL QUEUE (11.0+)
    -- ============================================
    "PreemptiveCastEnable",
    -- ============================================
    -- EMPOWER ABILITIES (10.0+ EVOKER)
    -- ============================================
    ...
    -- ============================================
    -- MISCELLANEOUS NEW CVARS (10.0-11.0)
    -- ============================================
    "combinedBags",
    ...
    -- ============================================
    -- ADDITIONAL MISSING CVARS FROM WOW CONFIG
    -- ============================================
    "accountList",
    "accountName",
    ...
    "wardrobeSetsFilters",
    -- ============================================
    -- FINAL BATCH - REMAINING MISSING CVARS
    -- ============================================
    "AIBrain",
    "AIEventLog",
    ...
    -- 12.0 MIDNIGHT CVARS
    -- ============================================
    -- Combat Audio Alerts (CAA) System
    "CAADebuffSelfAlert",
    "CAAEnabled",
    "CAAInterruptCast",
